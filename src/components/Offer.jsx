  ...
  return (
    <div className="py-20 bg-violet-pattern">
      ...
      <div className="container mx-auto rounded-3xl relative">
        ...
        ></div>
        <img src={logo} alt="" className="absolute right-10 top-10 md:top-20" />
        <div className="absolute bottom-12 md:bottom-32 left-8 md:left-16 space-y-8 text-3xl font-extrabold text-white">
          <p>Get Your </p>
